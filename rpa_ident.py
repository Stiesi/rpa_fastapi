...
def read_binarytml(btxt):
    '''
    read binary string from html file
    '''
    try:
...
def read_html(htmlfile=None,btxt=None): # not used by API
    '''
    read htmlfile data
